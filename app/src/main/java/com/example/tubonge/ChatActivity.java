...
import com.example.tubonge.adapter.ChatRecyclerAdapter;
import com.example.tubonge.models.ChatMessageModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference profilePicRef = FirebaseUtil.getOtherProfilePicStorageRef(otherUser.getUserId());
        ...
        }  // Handle the case where the StorageReference is null
        // For example, show an error message or use a placeholder image
    ...
    void setupChatRecyclerView(){
        if (chatroomId != null) {
            ...
            // For example, show an error message or handle it based on your application's logic
        }
    }
    ...
    void sendMessageToUser(String message){
        if (chatroomModel != null) {
            // Access chatroomModel properties here
        ...
        if (chatroomId != null) {
            FirebaseUtil.getChatroomReference(chatroomId).get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    if (chatroomModel == null) {
                        // First time chat: Create and set the chatroom model
                        ...
                        FirebaseUtil.getChatroomReference(chatroomId).set(chatroomModel)
                                .addOnSuccessListener(aVoid -> {
                                    // Chatroom model successfully created and set
                                })
                                .addOnFailureListener(e -> {
                                    // Handle failure to create and set chatroom model
                                });
                    }
                } else {
                    // Handle failure to retrieve chatroom model
                }
            });
        } else {
            // Handle the case where chatroomId is null
